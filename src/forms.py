...
class SubmissionForm(FlaskForm):
    ...
    al = SelectField('Albumin', choices=[(0, 'zero'), (1, 'one'),(2, 'two'),(3, 'three'),(4, 'four'),(5, 'five')], validators=[DataRequired()])
    su = SelectField('Sugar', choices=[(0, 'zero'), (1, 'one'),(2, 'two'),(3, 'three'),(4, 'four'),(5, 'five')], validators=[DataRequired()])
    rbc = SelectField('Red Blood cell', choices=[('normal', 'Normal'), ('abnormal', 'Abnormal')], validators=[DataRequired()])
    ...
    htn = SelectField('Red Blood cell count', choices=[('yes', 'Yes'), ('no', 'No')], validators=[DataRequired()])
